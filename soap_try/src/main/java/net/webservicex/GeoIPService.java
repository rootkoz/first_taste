 ...
 * 2016-04-20T12:29:10.893+03:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "GeoIPService", 
                  wsdlLocation = "file:src/main/resources/geoipservice.xml",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/geoipservice.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/geoipservice.xml");
        }
        WSDL_LOCATION = url;
    }
